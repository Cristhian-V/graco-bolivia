# prm-dashboard Specification

## Purpose

Navegación entre las secciones del panel de administración en React. La sección de PRMs (registros, resumen mensual e histórico) fue retirada.
